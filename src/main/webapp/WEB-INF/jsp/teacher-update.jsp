		...
		<form method="POST" action="${pageContext.request.contextPath}/school-app/teachers/update">
            ...
            <div class="row m-bottom justify-between">
                <div class="w-1/2">
                    ...
                    <input class="m-bottom p-1 border-2 rounded-md border-gray-500/75 focus:outline-2 focus:outline-blue-500" type="text" name="vat" value="${requestScope.updateDTO.vat}" placeholder="ΑΦΜ">
                    <p class="validation-error">${sessionScope.vatMessage}</p>
                </div>
                <div class="w-1/2">
                    <label for="fathername">Επώνυμο Πατρός:</label>
                    <input class="m-bottom p-1 border-2 rounded-md border-gray-500/75 focus:outline-2 focus:outline-blue-500" type="text" name="fathername" value="${requestScope.updateDTO.fatherName}" placeholder="Επώνυμο Πατρός">
                    <p class="validation-error">${sessionScope.fathernameMessage}</p>
                </div>
            </div>
            <div class="row m-bottom justify-between">
                <div class="w-1/2">
                    <label for="phoneNum">Αρ. Τηλεφώνου:</label>
                    <input class="m-bottom p-1 border-2 rounded-md border-gray-500/75 focus:outline-2 focus:outline-blue-500" type="text" name="phoneNum" value="${requestScope.updateDTO.phoneNum}" placeholder="Αριθμός Τηλεφώνου">
            ...
            <div class="row m-bottom justify-between">
                <div class="w-1/2">
                     ...
                     <input class="m-bottom p-1 border-2 rounded-md border-gray-500/75 focus:outline-2 focus:outline-blue-500" type="text" name="street" value="${requestScope.updateDTO.street}" placeholder="Οδός">
                     <p class="validation-error">${sessionScope.streetMessage}</p>
                </div>
                <div class="w-1/2">
                    <label for="streetNum">Αριθμός:</label>
                    <input class="m-bottom p-1 border-2 rounded-md border-gray-500/75 focus:outline-2 focus:outline-blue-500" type="text" name="streetNum" value="${requestScope.updateDTO.streetNum}" placeholder="Αριθμός">
            ...
            <div class="row m-bottom justify-between">
                <div class="w-1/2">
                    ...
                    <input class="m-bottom p-1 border-2 rounded-md border-gray-500/75 focus:outline-2 focus:outline-blue-500" type="text" name="zipcode" value="${requestScope.updateDTO.zipCode}" placeholder="ΤΚ">
